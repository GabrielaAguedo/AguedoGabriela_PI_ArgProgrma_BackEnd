...
import com.portfolio.gea.Dto.dtoPersona;
import com.portfolio.gea.Entity.Persona;
import com.portfolio.gea.Security.Controller.Mensaje;
import com.portfolio.gea.Service.ImpPersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersona dtopersona){
        ...
        Persona persona = new Persona(
                dtopersona.getNombre(), dtopersona.getApellido(), dtopersona.getDescripcion(), dtopersona.getEmail(), dtopersona.getProfesion(), dtopersona.getImgPerfil()
            );
